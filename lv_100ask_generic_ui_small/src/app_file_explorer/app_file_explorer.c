/**
 ******************************************************************************
 * @file    app_file_explorer.c
 * @author  百问科技
 * @version V1.0
 * @date    2024-8-15
 * @brief	app_file_explorer
 ******************************************************************************
 * Change Logs:
 * Date           Author          Notes
 ...
 *  STATIC PROTOTYPES
 **********************/
static int16_t app_file_explorer_open(void);
static int16_t app_file_explorer_close(void);
...
static int16_t app_file_explorer_close(void)
{
    lv_obj_delete(lv_100ask_app_file_explorer_t.cont);
    return 0;
}
